...
public class VideoListApi {
     ...
     */
    public com.squareup.okhttp.Call videoListGetCall(String openId, String accessToken, Integer count, Long cursor, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call videoListGetValidateBeforeCall(String openId, String accessToken, Integer count, Long cursor, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public VideoListResponse videoListGet(String openId, String accessToken, Integer count, Long cursor) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<VideoListResponse> videoListGetWithHttpInfo(String openId, String accessToken, Integer count, Long cursor) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call videoListGetAsync(String openId, String accessToken, Integer count, Long cursor, final ApiCallback<VideoListResponse> callback) throws ApiException {
